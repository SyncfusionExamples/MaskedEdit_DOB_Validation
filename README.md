# MaskedEdit DOB Validation

This repository contains sample for date of birth validation using the [Syncfusion Xamarin.Forms Masked Edit](https://help.syncfusion.com/xamarin/masked-entry/getting-started) control.
